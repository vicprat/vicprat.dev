...
const Work = () => (
  <Layout title="Margelo">
    <Container>
      ...
      <P>The corporate website for the elite app development and contracting agency based in Vienna, Austria.</P>
      <P>
        <Link href="https://twitter.com/mrousavy" target="_blank">
          Marc Rousavy <ExternalLinkIcon mx="2px" />
        </Link>
        , the founder of the agency, is my friend from the React Native community. I coded the design they&apos;ve sent me, which consists of parallax effects inspired by Apple. I&apos;ve published a
        video showing the process of building the website as a tutorial on YouTube.
      </P>
      ...
      <List ml={4} my={4}>
        ...
        <ListItem>
          <Meta>Stack</Meta>
          <span>Next.js / TypeScript / Vercel / Formspree / Fathom / Embla Carousel</span>
        </ListItem>
        <ListItem>
          <Meta>Video</Meta>
          <Link href="https://www.youtube.com/watch?v=GznmPACXBlY">
            How I built a software agency website with Next.js + Tailwind CSS (in nature) <ExternalLinkIcon mx="2px" />
          </Link>
        </ListItem>
      </List>
