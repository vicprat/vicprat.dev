import { Container, Badge, Link, List, ListItem, UnorderedList, Heading, Center, Image } from '@chakra-ui/react';
  ...
  <Layout title="freeDBTagger">
    <Container>
      ...
      <List ml={4} my={4}>
        ...
        <ListItem>
          <Meta>Download</Meta>
          <Link href="http://odoruinu.net.s3.amazonaws.com/software/freedbtagger/fdbt105.zip">v1.0.5</Link>
        </ListItem>
        <ListItem>
      ...
      <UnorderedList my={4}>
        <ListItem>
          <Link href="https://forest.watch.impress.co.jp/article/2005/02/01/freedbtagger.html">
            ...
            再生時間の組み合わせでアルバムを特定して楽曲情報を取得「freeDBTagger」 <ExternalLinkIcon mx="2px" />
          </Link>
        </ListItem>
      </UnorderedList>
      ...
      <Heading as="h4" fontSize={16} my={6}>
        <Center>
          User reviews&nbsp;
          <Link target="_blank" href="http://www.vector.co.jp/soft/cmt/win95/art/se350576.html">
            from Vector
          </Link>
        </Center>
      </Heading>
      ...
      <UnorderedList my={4}>
        <ListItem>
          ...
          <span>音質にこだわってFLACを使用している場合、 なかなかタグを自動で付けられるソフトはありませんが、 これはCDDBから曲情報をDLまでしてくれるので、 とてもお手軽簡単です。</span>
        </ListItem>
        <ListItem>
        ...
        <ListItem>
          ...
          <span>タグ編集はいろいろなソフトが出ていますが、DBから情報を拾ってくれる機能付では、このソフトが最高です。 操作も簡単で、手放せません。</span>
        </ListItem>
        <ListItem>
