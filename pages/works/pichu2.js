import { Container, Badge, Link, List, ListItem, UnorderedList, Heading, Center } from '@chakra-ui/react';
...
const Work = () => (
  <Layout title="pichu*pichu">
    <Container>
      ...
      <P>A Twitter client app for iPhone Safari, made in the iPhone 3GS era. I built it for my research work at a graduate school. Got over 2,000 users.</P>
      ...
      <UnorderedList my={4}>
        <ListItem>
          <Link href="http://www.donpy.net/standard-entry/app-reiview/4303.html">
            ...
            Webアプリ版twitterクライアントの「pichu*pichu」が凄い。 <ExternalLinkIcon mx="2px" />
          </Link>
        </ListItem>
        ...
        <ListItem>
          <Link href="http://labs.laurahouse.net/articles/iphone/1115.html">
            ...
            知っておきたいWebアプリ版Twitterクライアント活用法 <ExternalLinkIcon mx="2px" />
          </Link>
        </ListItem>
      </UnorderedList>
